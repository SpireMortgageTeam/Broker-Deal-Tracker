...
const FONT_SANS = '"TT Norms", system-ui, sans-serif';
const FONT_SERIF = '"Georgia Brand", Georgia, serif';
const FONT_SCRIPT = '"Brithney", cursive';
...
// Verbatim from the original spec, with photo paths adjusted to this app's
// public/ convention (Next.js serves public/insta-review/... at the root).
const TEAM: Broker[] = [
  { id: "renee", name: "Renée Huse", first: "Renée", photo: "/insta-review/assets/team/renee-huse.png", pos: "50% 16%", zoom: 1.25, wide: "50% 22%" },
  { id: "michael", name: "Michael", first: "Michael", photo: "/insta-review/assets/team/michael.jpg", pos: "50% 22%", zoom: 1.15, wide: "50% 26%" },
  { id: "adam", name: "Adam King", first: "Adam", photo: "/insta-review/assets/team/adam-king.jpg", pos: "52% 12%", zoom: 2.0, wide: "50% 18%" },
  { id: "natasha", name: "Natasha Rattai", first: "Natasha", photo: "/insta-review/assets/team/natasha-rattai.jpg", pos: "50% 18%", zoom: 1.12, wide: "50% 24%" },
  { id: "paul", name: "Paul de Andrade", first: "Paul", photo: "/insta-review/assets/team/paul-de-andrade.jpg", pos: "50% 20%", zoom: 1.15, wide: "50% 26%" },
  { id: "kristin", name: "Kristin", first: "Kristin", photo: "/insta-review/assets/team/kristin.jpg", pos: "50% 20%", zoom: 1.15, wide: "50% 26%" },
  { id: "sherri", name: "Sherri Bureyko", first: "Sherri", photo: "/insta-review/assets/team/sherri-bureyko.jpg", pos: "56% 22%", zoom: 1.6, wide: "54% 28%" },
  { id: "danielle", name: "Danielle Della Siega", first: "Danielle", photo: "/insta-review/assets/team/danielle-della-siega.jpg", pos: "50% 20%", zoom: 1.15, wide: "50% 26%" },
  { id: "mukul", name: "Mukul", first: "Mukul", photo: "/insta-review/assets/team/mukul.jpg", pos: "50% 20%", zoom: 1.15, wide: "50% 26%" },
  { id: "prashant", name: "Prashant Chudasama", first: "Prashant", photo: "/insta-review/assets/team/prashant-chudasama.jpg", pos: "50% 20%", zoom: 1.2, wide: "50% 26%" },
];
